...
{% callout %}To learn how to make a quiz and earn yourself a digital badge, try the Beginner App Inventor Sushi Cards at [dojo.soy/begin-sushi-apps](http://dojo.soy/begin-sushi-apps)
{% endcallout %}
